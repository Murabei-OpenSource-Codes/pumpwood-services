 ...
 */
export declare const ListService: <T>(api: ApiService, modelClass: string, body?: Record<any, any>) => Promise<[T | null, Error | null]>;
export declare const RetrieveService: <T>(api: ApiService, modelClass: string, pk: number) => Promise<[T | null, Error | null]>;
export declare const SaveService: <T>(api: ApiService, modelClass: string, body: Record<any, any>) => Promise<[T | null, Error | null]>;
/**
